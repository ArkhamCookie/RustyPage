...
favicon = "" # Put in your favicon's image data or url here.  I recommend using favicon.cc to get or create one; you can just copy all the image date after `base64,` in the href section.
